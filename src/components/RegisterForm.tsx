      ...
      <div className='w-full'>
         ...
         <form onSubmit={handleSubmit} className='space-y-4 sm:space-y-5'>
            ...
            <div className='my-auto flex gap-2 sm:gap-3 w-full'>
               <Link href={'/login'} className='flex-1 py-1.5 sm:py-1 px-2 sm:px-3 border border-foreground text-foreground rounded-md text-center text-sm sm:text-base'>SignIn</Link>
               <button type="submit" className="bg-foreground border-foreground flex-2 sm:flex-3 py-1.5 sm:py-1 px-2 sm:px-3 border rounded-md text-background hover:bg-background hover:text-foreground cursor-pointer font-bold text-sm sm:text-base">
                  {!isLoading ? (
                     <>Register</>
                  ) : (
                     <>processing...</>
